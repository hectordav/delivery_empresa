...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pedido_ver__ = __webpack_require__(356);
...
var PedidoVerPageModule = (function () {
    ...
    PedidoVerPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pedido_ver__["a" /* PedidoVerPage */]),
            ],
        })
    ], PedidoVerPageModule);
...
var PedidoVerPage = (function () {
    function PedidoVerPage(navCtrl, navParams, pr_pedido, pr_mensaje, alertCtrl, alert_toast) {
    ...
    PedidoVerPage.prototype.mensaje_repartidor = function () {
        var _this = this;
    ...
    PedidoVerPage.prototype.mensaje_cliente = function () {
        var _this = this;
    ...
    PedidoVerPage.prototype.cambiar_status_pedido = function () {
        var _this = this;
        var _titulo = "Entregar pedido a repartidor";
        var accion;
        var _mensaje = 'Desea entregar el pedido al repartidor?';
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.entregar_pedido_repartidor();
                    }
                }
            ]
        });
    ...
    PedidoVerPage.prototype.entregar_pedido_repartidor = function () {
        var _this = this;
        var token_cliente = this.result_pedido.token_usuario;
        var mensaje = 'Pedido entregado a repartidor';
        var _id_pedido = this.result_pedido.id_pedido;
        var _id_status_pedido = 3;
        this.pr_pedido.cambiar_status_pedido_establecimiento(_id_pedido, _id_status_pedido, token_cliente, mensaje).subscribe(function (pr_pedido) {
            console.log("REGISTRO EXISTE");
            var _titulo = "Info";
            var _mensaje = "Pedido Entregado al repartidor";
            _this.alert_toast.show_alert(_titulo, _mensaje);
